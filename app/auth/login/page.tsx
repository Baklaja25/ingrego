...
function LoginPageContent() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-white to-accent/30 p-4">
            ...
            <div className="relative bg-white/50 backdrop-blur-sm rounded-2xl p-8 border border-primary/10">
              <div className="space-y-4">
                ...
                <p className="text-gray-600">
                  Snap a photo of your ingredients and instantly get personalized
                  recipe suggestions. No more food waste, no more recipe blocks!
                </p>
